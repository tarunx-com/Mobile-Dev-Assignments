        ...
        <ScrollView contentContainerStyle={[styles.scrollContent, styleHelper.scrollContent]}
            ...
            <View style={[styles.card, styleHelper.card]}>
                ...
                <Text style={[styles.subheading, styleHelper.subheading]}>
                    Log in to your favorite kitchen
                </Text>
                ...
                {/* ── Forgot password ── */}
                <Pressable onPress={()=> alert('Forgot password flow coming soon!')} style={{ alignSelf: 'flex-end' }}>
                    <Text style={[styles.forgotPassword, styleHelper.forgotPassword]}>
                        Forgot Password?
                    </Text>
                </Pressable>
